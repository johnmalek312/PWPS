...
{
    public class DungeonDoorData : WorldItemBase , IDoor
    {
        ...
        public DungeonDoorData() : base(0, WorldInterface.BlockType.DungeonDoor)
        {
        }

        public DungeonDoorData(int itemId) : base(itemId, WorldInterface.BlockType.DungeonDoor)
        {
        }
