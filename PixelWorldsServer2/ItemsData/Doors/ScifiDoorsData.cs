...
{
    public class ScifiDoorData : WorldItemBase , IDoor
    {
        ...
        public int x;
        public int y;
        public ScifiDoorData() : base(0, WorldInterface.BlockType.ScifiDoor)
        {
        }

        public ScifiDoorData(int itemId) : base(itemId, WorldInterface.BlockType.ScifiDoor)
        {
        }
