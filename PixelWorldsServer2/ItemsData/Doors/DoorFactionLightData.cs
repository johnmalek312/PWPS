...
{
    public class DoorFactionLightData : WorldItemBase , IDoor
    {
        ...
        public int x;
        public int y;
        public DoorFactionLightData() : base(0, WorldInterface.BlockType.DoorFactionLight)
        {
        }

        public DoorFactionLightData(int itemId) : base(itemId, WorldInterface.BlockType.DoorFactionLight)
        {
        }
