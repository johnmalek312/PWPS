...
{
    public class DoorFactionDarkData : WorldItemBase , IDoor
    {
        ...
        public int x;
        public int y;
        public DoorFactionDarkData() : base(0, WorldInterface.BlockType.DoorFactionDark)
        {
        }

        public DoorFactionDarkData(int itemId) : base(itemId, WorldInterface.BlockType.DoorFactionDark)
        {
        }
