...
{
    public class CastleDoorData : WorldItemBase , IDoor
    {
        ...
        public int x;
        public int y;
        public CastleDoorData() : base(0, WorldInterface.BlockType.CastleDoor)
        {
        }

        public CastleDoorData(int itemId) : base(itemId, WorldInterface.BlockType.CastleDoor)
        {
        }
