...
{
    public class BarnDoorData : WorldItemBase , IDoor
    {
        ...
        public int x;
        public int y;
        public BarnDoorData() : base(0, WorldInterface.BlockType.BarnDoor)
        {
        }

        public BarnDoorData(int itemId) : base(itemId, WorldInterface.BlockType.BarnDoor)
        {
        }
