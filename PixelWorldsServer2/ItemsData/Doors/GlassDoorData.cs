...
{
    public class GlassDoorData : WorldItemBase , IDoor
    {
        ...
        public int x;
        public int y;
        public GlassDoorData() : base(0, WorldInterface.BlockType.GlassDoor)
        {
        }

        public GlassDoorData(int itemId) : base(itemId, WorldInterface.BlockType.GlassDoor)
        {
        }
