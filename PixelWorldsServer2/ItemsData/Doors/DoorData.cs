...
{
    public class DoorData : WorldItemBase
    {
        ...
        public int x;
        public int y;
        public DoorData() : base(0, WorldInterface.BlockType.Door)
        {
        }

        public DoorData(int itemId) : base(itemId, WorldInterface.BlockType.Door)
        {
        }
